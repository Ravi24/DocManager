...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../layout/boxed.html"><i class="fa fa-circle-o"></i> Society Master</a></li>
        ...
        <li>
          <a href="../widgets.html">
            <i class="fa fa-th"></i> <span>Document Manager</span>
            <span class="pull-right-container">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="http://bitcodes.in">Bitcodes</a>.</strong> All rights
    reserved.
  </footer>
